...
/// 计时器状态快照实体，用于断点续传。
///
/// - [kind]: simple = 简单计时，plan = 计划训练
/// - [sourceId]: 简单计时为配置哈希（如 JSON 或 hashCode），计划为 planId
/// - [status]: 0=ready, 1=running, 2=paused, 3=finished
/// - [startedAtWall]: 开始计时的墙钟时间
/// - [lastUpdatedAtWall]: 最后一次写入快照的墙钟时间
/// - [elapsedAtLastUpdateMicros]: 上次更新时的已用时长（微秒）
/// - [pausedAccumulatedMicros]: 累计暂停时长（微秒）
/// - [currentIntervalIndex]: 当前区间索引
@collection
class TimerSnapshot {
