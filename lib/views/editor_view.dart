...
class _EditorViewState extends State<EditorView> {
  ...
  Future<void> _save() async {
    ...
    if (errorTitle == null && _items.isEmpty) {
      errorTitle = '步骤列表为空';
      errorMessage = '请至少添加一个步骤';
    } else {
      // 计算总时长
  ...
  void _addStepDialog({PlanItem? existingItem, int? editIndex}) {
    ...
    // 默认值优化：新建步骤默认 Work 60秒，Intra Rest 60秒，Inter Rest 60秒
      ...
      builder: (context) {
        return StatefulBuilder(
          builder: (context, setDialogState) {
            ...
            final showIntraRest = currentSets > 1; // 只有组数>1时才显示组内休息
                  ...
                  children: [
                    ...
                    _setsInputWithSlider(
                      ...
                      onChanged: () {
                        ...
                        setDialogState(() {}); // 重新构建以更新组内休息的显示/隐藏
                      },
                    ),
                    const SizedBox(height: 16),
                    TimePicker(
                      ...
                      child: ListTile(
                        ...
                        trailing: Row(
                          ...
                          children: [
                            ...
                            // 使用 ReorderableDragStartListener 使拖拽手柄可交互
...
/// 组数输入组件（StatefulWidget 版本，用于管理 FocusNode）
